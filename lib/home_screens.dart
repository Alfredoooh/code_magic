  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          GestureDetector(
            ...
            child: Padding(
              ...
              child: CircleAvatar(
                radius: 18,
                backgroundImage:
                    (_userData?['photoURL'] is String && (_userData?['photoURL'] ?? '').isNotEmpty)
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        stream:
            FirebaseFirestore.instance.collection('messages').snapshots(), // sem filtros
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 40),
                _buildStatCard(
                    'Total de Mensagens', totalMessages.toString(), CupertinoIcons.chat_bubble_2_fill),
                SizedBox(height: 16),
                _buildStatCard('Tipo de Conta', _userData?['isPro'] == true ? 'Pro ⭐' : 'Grátis',
...
class MarketplaceScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('Marketplace', style: TextStyle(fontWeight: FontWeight.bold))),
      ),
      body: Center(
        child: Column(
...
class NewsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text('Novidades', style: TextStyle(fontWeight: FontWeight.bold))),
      ),
      body: Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Future<void> _sendMessage() async {
    ...
    try {
      ...
      // manter a lógica original: print do erro
  ...
  Future<void> _toggleReaction(String messageId, String reactionType) async {
    final user = _auth.currentUser;
    if (user == null) return;
              ...
              return Card(
                ...
                child: ExpansionTile(
                  leading: CircleAvatar(
                    backgroundImage:
                        (userData['photoURL'] is String && (userData['photoURL'] ?? '').isNotEmpty)
                      ...
                      child: Column(
                        ...
                        children: [
                          _buildAdminSwitch(
                            ...
                            (value) async {
                              await FirebaseFirestore.instance.collection('users').doc(userId).update({'admin': value});
                            },
                            Colors.purple,
                          ),
                          SizedBox(height: 12),
                          _buildAdminSwitch(
                            ...
                            (value) async {
                              await FirebaseFirestore.instance.collection('users').doc(userId).update({'isPro': value});
                            },
                            Colors.orange,
                          ),
                          SizedBox(height: 16),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Switch(value: value, onChanged: (v) => onChanged(v), activeColor: color),
        ],
      ),
    );
  }
