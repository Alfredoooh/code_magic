...
class _InvestScreenState extends State<InvestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Substituí o SliverAppBar por um AppBar padrão mantendo o conteúdo
      appBar: AppBar(
        backgroundColor: cardColor,
        elevation: 0,
        automaticallyImplyLeading: false,
        // Ajuste da altura para caber o segmento
        toolbarHeight: 72,
        titleSpacing: 16,
        title: Row(
          children: [
            SvgIcon(svgString: CustomIcons.trendingUp, color: iconColor, size: 28),
      ...
      body: SafeArea(
        child: Center(
          child: Column(
            ...
            children: [
              SvgIcon(
                svgString: CustomIcons.trendingUp,
                size: 80,
