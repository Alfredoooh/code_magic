          ...
          Expanded(
            child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (!snapshot.hasData || ((snapshot.data as dynamic).snapshot.value == null)) {
                  return const Center(child: CircularProgressIndicator());
                }
                
                final usersMap = Map<String, dynamic>.from((snapshot.data as dynamic).snapshot.value as Map);
  ...
  Widget _buildDirectMessages(User? user) {
    ...
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        final chatsMap = Map<String, dynamic>.from((snapshot.data as dynamic).snapshot.value as Map);
          ...
          itemBuilder: (context, index) {
            ...
            return FutureBuilder(
              ...
              builder: (context, userSnapshot) {
                if (!userSnapshot.hasData || ((userSnapshot.data as dynamic).snapshot.value == null)) {
                  return Container();
                }
                
                final otherUser = Map<String, dynamic>.from((userSnapshot.data as dynamic).snapshot.value as Map);
        ...
        Expanded(
          child: StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              final messagesMap = Map<String, dynamic>.from((snapshot.data as dynamic).snapshot.value as Map);
