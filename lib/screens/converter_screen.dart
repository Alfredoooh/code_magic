      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            CustomTextField(label: AppLocalizations.of(context)!.translate('amount')!, icon: Icons.numbers_rounded, onChanged: (value) => _amount = double.tryParse(value) ?? 0.0),
            const SizedBox(height: 24),
            CustomButton(text: AppLocalizations.of(context)!.translate('convert')!, onPressed: _convert),
            const SizedBox(height: 16),
            Text('${AppLocalizations.of(context)!.translate('result')!}: $_result'),
            // Historical chart
            SizedBox(
              height: 200,
              child: SparklineChart(data: [1.0, 1.1, 1.05, 1.2]), // Placeholder
            ),
          ],
        ),
      ),
