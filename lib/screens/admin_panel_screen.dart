...
class _AdminPanelScreenState extends State<AdminPanelScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: Icon(Icons.arrow_back, color: theme.appBarTheme.iconTheme?.color ?? appBarIconColor),
          onPressed: () => Navigator.pop(context),
        ),
        title: Text('Painel Admin', style: theme.textTheme.headlineSmall?.copyWith(color: theme.appBarTheme.titleTextStyle?.color ?? appBarTextColor, fontWeight: FontWeight.bold)),
        actions: [
          IconButton(
            icon: Icon(Icons.refresh, color: theme.appBarTheme.iconTheme?.color ?? appBarIconColor),
            onPressed: () {
              _loadStatistics();
              _updateChartsFromFirestore();
            },
        ...
        children: [
          Container(
            ...
            child: TabBar(
              ...
              unselectedLabelColor: appBarTextColor.withOpacity(0.7),
  ...
  Widget _buildDashboardTab(ThemeData theme) {
    return RefreshIndicator(
      ...
      child: ListView(
        ...
        children: [
          Text('Visão Geral em Tempo Real', style: theme.textTheme.headlineSmall?.copyWith(fontSize: 24, fontWeight: FontWeight.bold)),
  ...
  Widget _buildStatCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: theme.brightness == Brightness.dark ? Colors.black54 : Colors.black12, blurRadius: 8, offset: const Offset(0, 4))],
      ),
      child: Column(
            ...
            children: [
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(value, style: theme.textTheme.headlineSmall?.copyWith(fontSize: 22, fontWeight: FontWeight.bold, color: textColor)),
                    const SizedBox(height: 4),
                    Text(title, style: TextStyle(fontSize: 12, color: theme.textTheme.bodySmall?.color ?? Colors.grey[600])),
                  ],
                ),
              ),
              chart,
            ...
            children: [
              Row(
                children: [
                  ...
                  Text('Usuários Online (${onlineUsers.length})', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
                ],
              ),
              const SizedBox(height: 16),
              Wrap(
  ...
  Widget _buildChartCard({required String title, required List<FlSpot> data, required Color color, required ThemeData theme}) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(title, style: theme.textTheme.titleLarge?.copyWith(fontSize: 18, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          SizedBox(
            height: 200,
            child: LineChart(
  ...
  Widget _buildUserCard(Map<String, dynamic> userData, String userId, Color primaryColor) {
    ...
    return Card(
      ...
      child: ListTile(
        ...
        title: Row(
          children: [
            Flexible(child: Text(username, style: TextStyle(fontWeight: FontWeight.bold, color: theme.textTheme.bodyLarge?.color))),
            if (isPro) ...[
              const SizedBox(width: 8),
        ...
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(email, style: TextStyle(fontSize: 12, color: theme.textTheme.bodySmall?.color)),
            const SizedBox(height: 4),
            Text('$tokens tokens', style: TextStyle(fontSize: 12, color: theme.textTheme.bodySmall?.color)),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                Text(content, maxLines: 3, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodyMedium),
                const SizedBox(height: 12),
                Row(
                  children: [
                    const Icon(Icons.favorite, size: 18, color: Colors.red),
                    const SizedBox(width: 4),
                    Text('$likes', style: TextStyle(color: theme.textTheme.bodySmall?.color)),
                    const SizedBox(width: 16),
                    const Icon(Icons.comment, size: 18, color: Colors.blue),
                    const SizedBox(width: 4),
                    Text('$comments', style: TextStyle(color: theme.textTheme.bodySmall?.color)),
                    const SizedBox(width: 16),
                    const Icon(Icons.access_time, size: 18, color: Colors.grey),
                    const SizedBox(width: 4),
                    Text(_formatTimestamp(postData['timestamp']), style: TextStyle(color: theme.textTheme.bodySmall?.color, fontSize: 12)),
                  ],
                ),
              ],
            ),
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Text('Atividades em Tempo Real', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
            ],
          ),
        ),
        Expanded(
  ...
  Widget _buildAnalyticsTab(ThemeData theme) {
    ...
    return ListView(
      padding: const EdgeInsets.all(16),
      children: [
        Text('Analytics Avançado', style: theme.textTheme.headlineSmall?.copyWith(fontSize: 24, fontWeight: FontWeight.bold)),
        const SizedBox(height: 16),
        Row(
          children: [
